...
20/06/2017: I've put up this app to my personal account on AWS. (http://airtasker2.us-west-2.elasticbeanstalk.com) Elasticbeanstalk is connecting to RDS (Postgres) in the backend.
